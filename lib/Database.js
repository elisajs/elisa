...
export default class Database {
  ...
  findSchema(name, ...rest) {
    ...
    //(2) find
    if (this.sync) return sync((done) => this.readSchema(name, opts, done));
    else this.readSchema(name, opts, callback);
  }
  ...
  getStore(...args) {
    ...
    //(2) return
    return this.getSchema(sch, opts).getStore(store, opts);
  }
  ...
  findStore(...args) {
    ...
    //(2) read
    return this.getSchema(schema, opts).findStore(store, opts, callback);
  }
  ...
  getCollection(...args) {
    ...
    //(2) return
    return this.getSchema(sch, opts).getCollection(coll, opts);
  }
  ...
  findCollection(...args) {
    ...
    //(2) read
    return this.getSchema(schema, opts).findCollection(coll, opts, callback);
  }
}
